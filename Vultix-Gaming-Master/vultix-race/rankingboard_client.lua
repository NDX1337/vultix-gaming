...
local posLeftDistance = 5
local nameLeftDistance = 35
...
function RankingBoard:add(name, time)
 ...
 killerss = getPlayerName(getElementData(getPlayerFromPartialName(name),"lasthit")) or ""
alivePlayers = 0
...
setElementData(getPlayerFromPartialName(name),"lasthit",nil)
	...
	local playerLabel, playerLabelShadow = createShadowedLabelFromSpare(nameLeftDistance, y, 250, labelHeight, name .. " ("..killerss..")")
