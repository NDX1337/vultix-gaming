...
tip = title
  if id and not pickerTable[id] then
    ...
    guiBringToFront(pickerTable[id].gui.window)
    return true
  end
  return false
end
...
function colorPicker.create(id, start, title)
  ...
  cp.gui.edith = guiCreateLabel(338, 106, 64, 20, "H: 0В°", false, cp.gui.window)
...
function colorPicker:render()
  ...
  dxDrawImage(x+16, y+32, 256, 256, "colorpicker/sv.png", 0, 0, 0, self.color.white, self.gui.focus)
  dxDrawImage(x+288, y+32, 32, 256, "colorpicker/h.png", 0, 0, 0, self.color.white, self.gui.focus)
  dxDrawImageSection(x+8+math.floor(256*self.color.s), y+24+(256-math.floor(256*self.color.v)), 16, 16, 0, 0, 16, 16, "colorpicker/cursor.png", 0, 0, 0, self.color.white, self.gui.focus)
  dxDrawImageSection(x+280, y+24+(256-math.floor(256*self.color.h)), 48, 16, 16, 0, 48, 16, "colorpicker/cursor.png", 0, 0, 0, self.color.huecurrent, self.gui.focus)
...
function colorPicker:updateColor()
  ...
  guiSetText(self.gui.edith, "H: "..tostring(math.round(self.color.h*360)).."В°")
